  ...
  return (
    <div className="container-grid white-bg padding-top-10">
      <div className="section3__top-header--left">
        <p className="xxxl-size">How it works?</p>
      </div>
        ...
        <div className="flex-conainer">
          <div className="grid-container">
            ...
            <p className="p__ white-text md-size md-lh">
              Philosphy is considered a science but it is difficult to say when
              one has to compare with an ordinary science, for example biology,
              or chemistry. This is a question that turns into a burning problem
              among the scientists and liguists all ove the world...
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="section3__mid-section-2--text-container">s</div>
      <div className="section3__mid-section-3--img-container">
        <img src={img3} alt="" />
      </div>
      <div className="section3__mid-section-3--text-container">s</div>
    </div>
  );
};
